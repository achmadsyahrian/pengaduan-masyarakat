              ...
              <div class="card-body">
                <form action="pengaduan-tambah.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" required id="foto" aria-describedby="foto" aria-label="Upload" name="foto">
                  </div>
                  <div class="form-group">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="" class="table table-bordered table-hover table-striped">
                    ...
                    <tr class="text-center">
                      <td><?= $i++; ?></td>
                      <td><?= substr($row['isi_laporan'], 0, 70 ) . '...'; ?></td>
                      ...
                      <td>
                        <span class="badge 
                          <?php 
                            ...
                            elseif ($row['status'] === "proses") { echo "class= bg-warning"; $text = 'Proses';}
                            elseif ($row['status'] === "ditolak") { echo "class= bg-danger"; $text = 'Ditolak';} 
                      ...
                      <td class="project-actions">
                        <div class="btn-group btn-group-sm">
                          <?php if ($row['status'] === "0") : ?>
                          <a href="pengaduan-view?id=<?= $row['id_pengaduan'];?>" class="btn btn-info"><i class="fa-solid fa-pen"></i></a>
                          <a href="pengaduan-hapus?id=<?=$row['id_pengaduan'];?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                          <?php elseif ($row['status'] === "proses" || $row['status'] === "selesai" || $row['status'] === "ditolak") : ?>
                          <a href="pengaduan-detail?id=<?= $row['id_pengaduan'];?>" class="btn btn-success"><i class="fas fa-eye"></i></a>
                          <?php endif; ?>
                        </div>
                      </td>
                    </tr>
