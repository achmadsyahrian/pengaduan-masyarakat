...
$resultPengaduanMasuk = query("SELECT * FROM pengaduan WHERE status = '0'");


// $combined = array_combine($resultPengaduanMasuk, $resultMasyarakat);
        ...
        <div class="card-body pb-0">
          <div class="row">
            <?php if (count($resultPengaduanMasuk) > 0) :
                ...
                $nik = $row['nik'];
                $query = "SELECT * FROM masyarakat JOIN pengaduan ON masyarakat.nik = pengaduan.nik WHERE masyarakat.nik = '$nik' AND pengaduan.status = '0'";
