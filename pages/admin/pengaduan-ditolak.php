...
$resultPengaduanMasuk = query("SELECT * FROM pengaduan WHERE status = 'ditolak'");
        ...
        <div class="card-body pb-0">
          <div class="row">
            <?php if (count($resultPengaduanMasuk) > 0) :
                ...
                $nik = $row['nik'];
                $query = "SELECT * FROM masyarakat JOIN pengaduan ON masyarakat.nik = pengaduan.nik WHERE masyarakat.nik = '$nik' AND pengaduan.status = 'ditolak'";
