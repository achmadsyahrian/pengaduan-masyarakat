                ...
                <form action="profile-ubah.php" method="POST">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      <input type="text" id="nama" maxlength="35" required class="form-control" name="nama" value="<?=$data['nama_petugas'];?>">
                      <input type="hidden" class="form-control" name="id_petugas" value="<?=$data['id_petugas'];?>">
